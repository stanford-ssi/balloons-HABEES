...
double Sensors::getAltitude() {
  ...
  if (altitude_1 >= -50 && altitude_2 >= -50) altitudeCurr = (altitude_1 + altitude_2) / 2;
  else if (altitude_1 >= -50 && altitude_2 <= -50) altitudeCurr = altitude_1;
  else if (altitude_2 >= -50 && altitude_1 <= -50) altitudeCurr = altitude_2;
  else altitudeCurr = baro.getAltitude();
  return altitudeCurr;
}
